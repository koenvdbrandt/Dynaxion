/**
 * @file
 * @brief Definition of scintillator digitization module
...
#ifndef ALLPIX_SCINTILLATOR_DIGITIZER_MODULE_H
#define ALLPIX_SCINTILLATOR_DIGITIZER_MODULE_H
...
namespace allpix {
     ...
     */
    class ScintillatorDigitizerModule : public Module {
    public:
        /**
         ...
         */
        ScintillatorDigitizerModule(Configuration& config, Messenger* messenger, std::shared_ptr<Detector> detector);
...
#endif /* ALLPIX_SCINTILLATOR_DIGITIZER_MODULE_H */
