...
#include "G4String.hh"
#include "GB01BOptrChangeCrossSection.hpp"
...
void GB01BOptrMultiParticleChangeCrossSection::AddParticle(G4String particleName) {
    ...
    LOG(TRACE) << "ADDED A PARTICLE " << particleName;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

G4VBiasingOperation*
GB01BOptrMultiParticleChangeCrossSection::ProposeOccurenceBiasingOperation(const G4Track* track,
                                                                           const G4BiasingProcessInterface* callingProcess) {
    LOG(TRACE) << "STEP 2 AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
...
void GB01BOptrMultiParticleChangeCrossSection::StartTracking(const G4Track* track) {
    LOG(TRACE) << "STEP 3 AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
...
void GB01BOptrMultiParticleChangeCrossSection::OperationApplied(const G4BiasingProcessInterface* callingProcess,
    ...
    LOG(TRACE) << "STEP 4 AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
