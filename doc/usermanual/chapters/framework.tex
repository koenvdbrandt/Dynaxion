...
\item An optional parameter \parameter{mother_volume} to specify the mother volume of the detector. The mother volume can be chosen from the passive materials defined in Section~\ref{sec:passive_material_config}. Defaults to the world frame.
...
\item \parameter{scintillator_shape}: A required parameter describing the shape of the scintillor.
For scintillators the shape has to be either \parameter{box} or \parameter{cylinder}.
\item \parameter{scintillator_size}: A required parameter describing the size of the scintillator.
For a box-shaped scintillator, the \parameter{scintillator_size} is the 3D size of the scintillator, while for a cylinder-shaped scintillator, the \parameter{scintillator_size} is a 2D vector describing the radius and the length of the scintillator. 
...
Each optical surface requires four inputs, a \parameter{surface model}, a \parameter{surface type}, a \parameter{surface finish} and a \parameter{surace value} .
...
\item \parameter{surface finish}: Describes the structure of the surface of the interface.
    ...
    \begin{itemize}
        ...
        \item \textbf{8}: \parameter{polishedair}: mechanically polished surface, with air.
        ...
        \item \textbf{16}: \parameter{etchedair}: chemically etched surface, with air.
        ...
        \item \textbf{21}: \parameter{groundlumirrorair}: rough-cut surface, with lumirror \& air.
        \item \textbf{23}: \parameter{groundlumirrorglue}: rough-cut surface, with lumirror \& meltmount.
        \item \textbf{24}: \parameter{groundair}: rough-cut surface, with air.
        ...
        \item \textbf{28}: \parameter{groundvm2000glue}: rough-cut surface, with esr film \& meltmount.
    \end{itemize}
